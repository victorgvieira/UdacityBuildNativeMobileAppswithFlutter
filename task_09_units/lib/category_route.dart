...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  // DONE Step 4.1: Remove _categoryNames as they will be retrieved from the JSON asset
...
//  ];
  ...
  // DONE Step 4.2: Remove the overriding of initState(). Instead, we use
...
//  }
  ...
  // DONE Step 4.3: Uncomment this out. We use didChangeDependencies() so that we can
  ...
  Future<void> _retrieveLocalCategories() async {
    ...
    // DONE Step 4.4: Create Categories and their list of Units, from the JSON asset
    var categoryIndex = 0;
  ...
  // DONE Step 4.5: Delete this function; instead, read in the units from the JSON asset

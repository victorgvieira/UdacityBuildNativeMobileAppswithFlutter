...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  // DONE Step 3.0: Use a GridView for landscape mode, passing in the device orientation from MediaQuery
  /// Makes the correct number of rows for the list view, based on whether the
  /// device is portrait or landscape.
  ///
  /// For portrait, we use a [ListView]. For landscape, we use a [GridView.count].

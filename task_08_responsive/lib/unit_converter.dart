...
class _UnitConverterState extends State<UnitConverter> {
  ...
  // DONE Step 3.1: Pass this into the TextField so that the input value persists
  ...
  Widget build(BuildContext context) {
    ...
    // DONE Step 3.2: Use a ListView instead of a Column
...
//      crossAxisAlignment: CrossAxisAlignment.stretch,
    ...
    // DONE Step 3.3: Use an OrientationBuilder to add a width to the unit converter
    // in landscape mode
    return Padding(
      padding: _padding,
//      child: converter,

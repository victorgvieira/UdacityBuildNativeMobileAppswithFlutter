    ...
    if (deviceOrientation == Orientation.portrait) {
      return ListView.builder(
        itemBuilder: (BuildContext context, int index) {
          // DONE Step 3: You may want to make the Currency [Category] not tappable
          // while it is loading, or if there an error.
          var category = _categories[index];
          var apiCategoryName = apiCategory["name"];
          var onTapListener;
          if (category.name == apiCategoryName && category.units.isEmpty) {
            onTapListener = null;
          } else {
            onTapListener = _onCategoryTap;
          }
          return CategoryTile(
            category: category,
            onTap: onTapListener,
